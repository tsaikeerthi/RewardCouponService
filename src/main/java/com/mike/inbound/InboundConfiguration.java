...
//            Transaction transaction = (Transaction) message.getPayload();
                ...
                if (!payloadString.contains("brand_name")) {
...
//                    }
 ...
 //                   messagingGateway.sendToPubsub(messageCoupon);
                    emailService.sendEmailWithTemplate("digitalgenx55@gmail.com",couponDetails.getBrand_name(),"AMZ99000", couponDetails.getOffer());
